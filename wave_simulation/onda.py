...
for m in range(Nr - 1):
    ...
    for i in range(Nz):
        # ---- Única alteração: índice de refração do fundo agora é realista (<1) ----
        n_atual = 1.0 if z[i] < prof_fundo else 0.95 + 0.05j   # fundo: velocidade ~1579 m/s, leve absorção
